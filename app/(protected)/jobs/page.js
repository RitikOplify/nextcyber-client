              ...
              <div className=" hidden sm:block bg-g-800 py-10 px-5 flex-1 h-fit rounded-[10px] border border-g-500">
                ...
                <div className=" mt-7.5">
                  ...
                  <p className=" text-g-300 font-normal leading-6 mt-3">
                    ...
                    trust in the capital markets. Enabled by data and
                    technology, diverse EY teams in over 150 countries provide
                    trust through assurance and help clients grow, transform and
                    operate.
                  </p>
                </div>
                <div className="mt-7.5">
